      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="<?php echo e(url('/admin/edit_team/'.$teamDetails->id)); ?>" name="edit_team" id="edit_team" novalidate="novalidate">
              <div class="control-group">
              	<?php echo e(csrf_field()); ?>

                <label class="control-label">Name</label>
                <div class="controls">
                  <input type="text" name="name" id="name" value="<?php echo e($teamDetails->name); ?>">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Description</label>
                <div class="controls">
                  <textarea type="text" name="description" id="description"><?php echo e($teamDetails->description); ?></textarea>
                </div>
              </div>
