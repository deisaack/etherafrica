        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-5 col-md-offset-1 wow fadeInUp">
                    ...
                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $about): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-5">
                    <div class="page-title">
                        <h2 class="title wow fadeInUp"><?php echo e($product->heading); ?></h2>
                ...
                <div class="hidden-xs col-sm-6 col-md-offset-1">
                    <img src="<?php echo e(asset('images/about/medium/'.$product->image)); ?>" alt="">
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
                ...
                <div class="col-xs-6 col-sm-4 col-md-3">
                    <div class="team-box wow fadeInUp" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="<?php echo e(asset('images/pictures/medium/'.$team->image)); ?>" alt="">
                        </div>
                        <div class="team-hover">
                            <h5 class="t_title"><?php echo e($team->name); ?></h5>
                            <span class="t_sub_title"><?php echo e($team->description); ?></span>
                ...
                <div class="col-xs-12 col-md-6">
                    <div class="blog-lists">
                        ...
                        <div class="blog-list wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <h5><a href="<?php echo e(url('/blog')); ?>"><?php echo e($blogger->blog_name); ?></a></h5>
                            <div class="blog-list-meta"> <i class="icofont icofont-ui-calendar"></i> <?php echo e($blogger->date); ?></div>
                            <p><?php echo e($blogger->summary); ?></p>
                        </div>
                     <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-xs-12 col-md-8">
                        <div class="contact-form">
                            <form action="<?php echo e(url('/contact-form')); ?>" method="post">
